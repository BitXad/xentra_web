...
<div class="box-header">
    <h3 class="box-title">Galeria de imagenes de <b><?php echo $nombre_asoc; ?></b></h3>
...
<div class="row">
                ...
                <p>
                    <?php
                        ...
                        foreach($all_imagen_asociado as $imagen)
                        {
                            ...
                            $mimagen = "thumb_".$imagen['imagenasoc_archivo'];
                    
                            //echo "<div id='colum5'>";
                            echo "<a class='fancybox' href='".site_url('/resources/images/imgasociados/'.$imagen['imagenasoc_archivo'])."' data-fancybox-group='gallery' title='".$imagen['imagenasoc_titulo']."'>";
                            echo "<img src='".site_url('/resources/images/imgasociados/'.$mimagen)."' alt='' /></a>";
                            //echo "</div>";
                            if(($cont % $colum) == 0){
                                echo "<br>";
                            }
    ...
    <center>
        <a href="<?php echo site_url('imagen_asociado/catalogo/'.$id_asoc); ?>" class="btn btn-sq-lg btn-danger" style="width: 120px !important; height: 120px !important; " ><span class="fa fa-sign-out fa-4x"></span><br>Salir</a>
    </center>
</div>
</div>
