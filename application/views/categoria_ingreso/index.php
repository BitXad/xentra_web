...
<div class="box-header" style="padding-left: 0px">
    <font class="text-bold" size='4' face='Arial'>Categoria Ingreso</font>
    <div class="box-tools">
            ...
            <div class="box-body table-responsive">
                <table class="table table-condensed" id="mitabla">
                    ...
                    <tr>
                        ...
                        <td class="text-bold" style="font-size: 12pt"><?php echo $c['nom_cating']; ?></td>
                        <td class="text-center">
                            <a href="<?php echo site_url('categoria_ingreso/edit/'.$c['id_cating']); ?>" class="btn btn-info btn-xs" title="Modificar categoria ingreso"><span class="fa fa-pencil"></span> </a> 
