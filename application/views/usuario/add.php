                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <select name="tipo_usuario" class="form-control" required>
                                    ...
                                    {
                                        $selected = ($tipo_usuario['tipousuario_descripcion'] == $this->input->post('tipo_usuario')) ? ' selected="selected"' : "";
                                        echo '<option value="'.$tipo_usuario['tipousuario_descripcion'].'" '.$selected.'>'.$tipo_usuario['tipousuario_descripcion'].'</option>';
                                    } 
                                    ?>
                                </select>
                            </div>
