					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_usu" class="form-control">
								...
								{
									$selected = ($asociado['id_asoc'] == $this->input->post('id_usu')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="estado_ing" class="form-control">
								...
								{
									$selected = ($value == $this->input->post('estado_ing')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="tipo_ing" class="form-control">
								...
								{
									$selected = ($value == $this->input->post('tipo_ing')) ? ' selected="selected"' : "";
