    ...
    <tr>
        ...
        <td style="width: 40%; padding: 20;line-height:15px;" > 
            <center>
                ...
                <font size="2" face="arial"><b>Nº: 00<?php echo $ingresos[0]['id_ing']; ?></b></font> <br>
    ...
    <table style="margin-left:0; width: 95%; font-family: Arial; font-size:10px;"> 
            ...
            <tr>
                ...
                <td class="todo"><b>MONTO: </b>                         
                    <?php echo number_format($ingresos[0]['monto_ing'],'2','.',',');?> Bs.</td>                      
            </tr>
            <tr>
                <td class="vacio"></td>
            </tr>
            <tr>
                ...
                <td class="todo"><b>CONCEPTO: </b>   
                    <?php echo$ingresos[0]['detalle_ing'];?> (<?php echo$ingresos[0]['descripcion_ing'];?>)</td>
            </tr>
            <tr>
                <td class="vacio"></td>
            </tr>
            <tr>
                ...
                <td class="todo"><b>SON: </b>   
                    <?php echo num_to_letras($ingresos[0]['monto_ing']);?> </td>
            </tr>
            <tr>
                <td class="vacio"></td>
            </tr>
            <tr>
                ...
                <td class="todo"><b>CAJERO: </b> 
                    <?php echo$ingresos[0]['nombre_usu'];?></td>
            </tr>
            <tr>
                <td class="vacio"></td>
            </tr>
...
<div class="row" style="padding-left: 7%;padding-top: 0.5%">
     <font size="1" face="Arial"><b>Nº Trans.:</b> 00<?php echo $ingresos[0]['id_ing']; ?></font>              
</div>
</div>
