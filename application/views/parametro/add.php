    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Añadir Parametro</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="number" name="dias_param" value="<?php echo $this->input->post('dias_param'); ?>" class="form-control" id="dias_param" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="monto_param" class="control-label">Monto (Bs)</label>
						<div class="form-group">
							<input type="number" step="any" name="monto_param" value="<?php echo $this->input->post('monto_param'); ?>" class="form-control" id="monto_param" />
						</div>
					</div>
					<div class="col-md-6">
