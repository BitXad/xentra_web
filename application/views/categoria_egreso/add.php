          		...
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
                                                    <input type="text" name="nom_categr" value="<?php echo $this->input->post('nom_categr'); ?>" class="form-control" id="nom_categr" autofocus autocomplete="off" onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" />
