					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="estado" class="form-control">
								...
								{
									$selected = ($value == $asociado['estado']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="tipo_asoc" class="form-control">
								...
								{
									$selected = ($value == $asociado['tipo_asoc']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="zona_asoc" class="form-control">
								...
								{
									$selected = ($value == $asociado['zona_asoc']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="servicios_asoc" class="form-control">
								...
								{
									$selected = ($value == $asociado['servicios_asoc']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="categoria_asoc" class="form-control">
								...
								{
									$selected = ($value == $asociado['categoria_asoc']) ? ' selected="selected"' : "";
