					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="tipo_fact" class="form-control">
								...
								{
									$selected = ($value == $factura['tipo_fact']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="estado_fact" class="form-control">
								...
								{
									$selected = ($value == $factura['estado_fact']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_usu" class="form-control">
								...
								{
									$selected = ($usuario['id_usu'] == $factura['id_usu']) ? ' selected="selected"' : "";
