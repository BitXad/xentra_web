          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							<input type="text" name="detalle_ap" value="<?php echo $this->input->post('detalle_ap'); ?>" class="form-control" onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" id="detalle_ap" />
						</div>
					</div>
					<div class="col-md-4">
