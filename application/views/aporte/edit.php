					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="mes_ap" class="form-control">
								...
								{
									$selected = ($value == $aporte['mes_ap']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="gestion_ap" class="form-control">
								...
								{
									$selected = ($value == $aporte['gestion_ap']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_usu" class="form-control">
								...
								{
									$selected = ($usuario['id_usu'] == $aporte['id_usu']) ? ' selected="selected"' : "";
