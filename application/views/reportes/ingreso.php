...
<script src="<?php echo base_url('resources/js/reporte_deingresos.js'); ?>" type="text/javascript"></script>
...
<div class="box-header no-print">
    ...
    <div class="col-md-3">
        Categor&iacute;a:
        <select  class="btn btn-primary btn-sm form-control" id="nom_cating" name="nom_cating" required>
            <option value="ning"> TODAS </option>
            <?php foreach($all_categoria as $categoria){?>
            <option value="<?php echo $categoria['nom_cating']; ?>"><?php echo $categoria['nom_cating']; ?></option>
            <?php } ?>
        </select>
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-4">
        <br>
        <span class="badge btn-primary" style="height: 34px; padding-top: 5px;">Ingresos encontrados: <span class="badge btn-primary"><input style="border-width: 0; width: 55px" id="resingegr" type="text" value="0" readonly="true"> </span></span>
    </div>
    <div class="col-md-3">
        <br>
                ...
                <table style="width: 100%; font-family: Arial !important;" >
                    ...
                    <tr>
                        <td class="labjizqder labjf text-center" style="width: 75%; line-height: 0.9">
                            ...
                            <font size="1" face="arial"><b>COBROS REGISTRADOS EN RECIBOS DE INGRESOS</b></font>
                        </td>
