...
<script src="<?php echo base_url('resources/js/reporte_mensuales.js'); ?>" type="text/javascript"></script>
...
<div class="box-header no-print">
    <h3 class="box-title"><b>REPORTE DE INGRESOS DEVENGADOS</b></h3><br>
    <div class="col-md-3">
        Mes:
    ...
    <div class="col-md-4">
        <br>
        <span class="badge btn-primary" style="height: 34px; padding-top: 5px;">Encontrados: <span class="badge btn-primary"><input style="border-width: 0; width: 55px" id="resencontrados" type="text" value="0" readonly="true"> </span></span>
    </div>
    <div class="col-md-3">
        <br>
                ...
                <table style="width: 100%; font-family: Arial !important;" >
                    ...
                    <tr>
                        <td class="labjizqder labjf text-center" style="width: 80%; line-height: 0.9">
                            <font size="4" face="arial"><b>REPORTE DE INGRESOS DEVENGADOS</b></font> <br>
