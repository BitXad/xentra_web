...
function buscar_por_fecha(){
    ...
    fechabusquedaingegr(fecha_desde, fecha_hasta, usuario, nom_cating, orden_por);
...
function fechabusquedaingegr(fecha_desde, fecha_hasta, usuario, nom_cating, orden_por){
    var base_url    = document.getElementById('base_url').value;
    var controlador = base_url+"reportes/buscaringresos";
    document.getElementById('loader').style.display = 'block'; //muestra el bloque del loader
    $.ajax({url: controlador,
           type:"POST",
           data:{fecha1:fecha_desde, fecha2:fecha_hasta, usuario_id:usuario, nom_cating:nom_cating,
                 orden_por:orden_por},
           ...
           success:function(resul){
               ...
               if (registros != null){
                    ...
                    var escategoria =  $('#nom_cating option:selected').text();
                    ...
                    for (var i = 0; i < n ; i++){
                        totalingreso += parseFloat(registros[i]['monto_ing']);
                        html += "<tr class='labjf'>";
