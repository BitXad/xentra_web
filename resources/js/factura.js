...
//                        html += "   <td><a href='"+base_url+"factura/imprimir_factura/"+factura[i]["venta_id"]+"' class='btn btn-warning btn-xs' ' target='_BLANK'><i class='fa fa-list'></i> </a>";
                        ...
                        html += "   <a href='"+base_url+"factura/imprimir_factura/1/"+factura[i]["id_fact"]+"' class='btn btn-default btn-xs' ' target='_BLANK' title='Imprimir factura copia'><i class='fa fa-list'></i> </a>";
                        if(rolusuario_asignado == 1){
                            html += "  <button class='btn btn-danger btn-xs' onclick='anular_factura("+factura[i]["id_fact"]+","+factura[i]["id_fact"]+","+factura[i]["num_fact"]+","+'"'+factura[i]["razon_fact"]+'"'+","+factura[i]["montototal_fact"]+","+'"'+factura[i]["fecha_fact"]+'"'+")'><i class='fa fa-trash'></i> </button></td>";
                        }
                        html += "</tr>";
